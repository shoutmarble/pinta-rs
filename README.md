...
- Version `0.1.0` is the first tagged workspace snapshot, including a Linux release artifact under `releases/0.1.0/`.

## Release 0.1.0

- Git tag: `0.1.0`
- Release artifact: `releases/0.1.0/pinta-rs-0.1.0-linux-x86_64.tar.gz`
