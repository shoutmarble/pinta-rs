...
fn vendored_standard_icon_source(name: &'static str) -> Option<&'static str> {
    match name {
        ...
        "view-reveal-symbolic.svg" => Some(include_str!("../../assets/standard-icons/actions/view-reveal-symbolic.svg")),
        "view-conceal-symbolic.svg" => Some(include_str!("../../assets/standard-icons/actions/view-conceal-symbolic.svg")),
        "image-x-generic-symbolic.svg" => Some(include_str!("../../assets/standard-icons/actions/image-x-generic-symbolic.svg")),
